...
import os
mongo_uri = os.environ.get('MONGO_URI', "mongodb+srv://ramongo:LeoyDem01@cluster0.1fgzarl.mongodb.net/dbapp?retryWrites=true&w=majority&appName=Cluster0&connectTimeoutMS=10000&socketTimeoutMS=10000")
